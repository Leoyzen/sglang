...
def _patched_sparse_kernels(
    ...
    q8_mod = types.ModuleType("sglang.kernels.ops.attention.sparse_mla_q8kv8_prefill_sm90")
    ...
    old_modules = {
        ...
        for name in (
            ...
            "sglang.kernels.ops.attention.sparse_mla_q8kv8_prefill_sm90",
        )
    }
    sys.modules["sgl_kernel"] = sgl_kernel_pkg
    sys.modules["sgl_kernel.flash_mla"] = flash_mla_mod
    sys.modules["sglang.kernels.ops.attention.sparse_mla_q8kv8_prefill_sm90"] = q8_mod
    try:
        yield
    finally:
