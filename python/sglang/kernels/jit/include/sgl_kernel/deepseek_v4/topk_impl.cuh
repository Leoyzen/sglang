...
#pragma unroll
  ...
  ///
  /// The histogram is the overlay member `tie_values`/`refine_hist`: what phase 3
...
#pragma unroll
    ...
    handle_tie(smem->tie_values, problem, above_count, tie_count, remain_topk, handle);
  }
};
...
#pragma unroll
    ...
    if (count_eq > kMaxNumTie) [[unlikely]] {
      ...
      refine_and_handle_tie(problem, smem, v_lo, v_hi, count_eq);
      return;
    }
