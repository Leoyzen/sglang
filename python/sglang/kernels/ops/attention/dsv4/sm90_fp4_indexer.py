...
def _fp4_index_logits_kernel(
    ...
    # Static graph capacity can extend beyond every visible key in this tile.
    if lb * BLOCK_L < tl.minimum(n_vis, L):
        ...
        # Invisible tile: skip the loads and dot products, but still emit the
        # -inf tail and candidate block scores so downstream top-k stays valid.
